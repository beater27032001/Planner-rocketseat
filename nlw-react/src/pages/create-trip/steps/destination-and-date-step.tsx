...
interface DestinationAndDateStepProps {
  ...
  setIsEventStartAndEndDates:(dates: DateRange | undefined) => void;
          ...
          <div className="rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold">Selecione o data</h2>
                <button>
                  <X
            ...
            <DayPicker mode="range" selected={eventStartAndEndDates} onSelect={setIsEventStartAndEndDates}/>
          </div>
        </div>
      )}
